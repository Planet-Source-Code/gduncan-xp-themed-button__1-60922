...
Begin VB.UserControl Duncan_XPButton 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   318
   ToolboxBitmap   =   "Duncan_XPButton.ctx":0000
...
Private Sub DrawThemeButton()
    ...
    If Not UserControl.Ambient.UserMode Then
        'we are in design mode so draw something visible (toolbar isnt in normal mode)
        If Enabled Then
            If m_ButtonStyle = Toolbar Then
                lStateId = Hot
            End If
        End If
    End If
        ...
        If hTheme <> 0 Then
            ...
            If Len(m_Caption) > 0 Then
                retval = GetThemeBackgroundContentRect( _
                 ...
                 Case bottomleft
                    tTextR.Bottom = tTextR.Bottom - m_CaptionPadding
